...
const (
	staticListHeader = `// Copyright (C) 2019-2026 Ni Rui <ranqus@gmail.com>
// Copyright (C) 2026 Snuffy2
// SPDX-License-Identifier: AGPL-3.0-only
//
// This file is generated by "go generate"; do not edit it directly.
...
var (
	...
	staticPageTemplate = `// Copyright (C) 2019-2026 Ni Rui <ranqus@gmail.com>
