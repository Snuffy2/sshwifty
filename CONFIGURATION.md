  ...
  "Presets": [
    {
      ...
      "Meta": {
        ...
        // Data for predefined Password field. If SSHWIFTY_PRESET_SECRET_KEY is
        // set, plaintext Password values are encrypted on startup, written back
        // as Encrypted Password, and removed from the JSON file.
